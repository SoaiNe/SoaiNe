...
h1.post-title.entry-title a,h2.post-title.entry-title a{color:#555!important;letter-spacing:-.6px;margin:0;font:500 20px Roboto;line-height:1.3!important}
...
siteiu{background:#fff}
h1.post-title.entry-title,h2.post-title.entry-title{text-transform:uppercase;color:#222!important;letter-spacing:-0.4px;margin:0;font:600 21px Roboto;line-height:1.3;text-align:center}
h1.post-title.entry-title a,h2.post-title.entry-title a{color:#555!important;letter-spacing:-.6px;margin:0;font:500 20px Roboto;line-height:1.3!important}
h1.post-title.entry-title a:hover,h2.post-title.entry-title a:hover{color:#4fa5de!important}
  </style></b:if>
<style type='text/css'>
...
.siteiu{max-width:1280px;padding:0 5px 0 5px;margin:0 auto;overflow:hidden;margin-top:15px}
...
.entry-metaiu a{color:#95a5a6}
.entry-metaiu i{font-size:18px}
@keyframes shake{
...
.post{background:#fff;margin-top:20px;padding:15px;transition:all 0.3s cubic-bezier(.25,.8,.25,1);box-shadow:4px 4px 8px 0 rgba(0,0,0,0.05);}
...
<label class='resmenu'><span class='title-menu'>Hiê&#769;u</span>
...
.hamburger{font-size:18px;background:#fff;height:2px;display:block;position:relative;top:6px;width:}
...
<div id='banner'>
  <div class='banner-left'><img src='https://accgame24h.vn/anh/1 (3) (1).jpg' width='100%'/></div>
...
<div class='vienkhung'>
<span class='natata'/><span class='netete'/><span class='nototo'/><span class='nututu'/>
<b:if cond='data:blog.pageType != &quot;static_page&quot;'>
<b:if cond='data:blog.pageType != &quot;item&quot;'>
<script type='text/javascript'>
snippet_count = 100;
...
<div class='post-thumb'>
  <span class='zoom-img'><a expr:href='data:post.url' expr:title='data:post.title'><i class='shade-icon'/></a></span><script type='text/javascript'>
document.write(gravity_thumbnail(&quot;<data:post.thumbnailUrl/>&quot;,&quot;<data:post.title/>&quot;));
  </script>
  </div></div>
</b:if>
</b:if>
...
<b:if cond='data:blog.pageType == &quot;index&quot;'>
<style>
.hienthi {float:left;width:33.3%;text-align:center;color:#999;font-size:13px;font-weight:bold}
  .champ, .trangphuc, .botro{color:#000}
</style>
 <div class='hienthi'><br/><div class='champ' expr:data-url='data:post.url'/></div> 
 <div class='hienthi'><br/><div class='trangphuc' expr:data-url='data:post.url'/></div>
 <div class='hienthi'><br/><div class='botro' expr:data-url='data:post.url'/></div>
<b:if cond='data:post.labels'>
<b:loop values='data:post.labels' var='label'>
<b:if cond='data:label.name == &quot;d?ng&quot;'>
<div style='width:70px;text-align:center;position:absolute;bottom:105px;right:5px;color:#fff'><img src='https://imgur.com/ln1snxI.png'/><br/> <div class='ranked' expr:data-url='data:post.url'/>  </div>  </b:if>
<b:if cond='data:label.name == &quot;b?c&quot;'>
<div style='width:70px;text-align:center;position:absolute;bottom:105px;right:5px;color:#fff'><img src='https://imgur.com/crpERhk.png'/><br/> <div class='ranked' expr:data-url='data:post.url'/>  </div>  </b:if>
<b:if cond='data:label.name == &quot;vàng&quot;'>
<div style='width:70px;text-align:center;position:absolute;bottom:105px;right:5px;color:#fff'><img src='https://imgur.com/IGwihOn.png'/><br/> <div class='ranked' expr:data-url='data:post.url'/>  </div>  </b:if>
<b:if cond='data:label.name == &quot;b?ch kim&quot;'>
<div style='width:70px;text-align:center;position:absolute;bottom:105px;right:5px;color:#fff'><img src='https://imgur.com/QPYw8X6.png'/><br/> <div class='ranked' expr:data-url='data:post.url'/>  </div> </b:if>
<b:if cond='data:label.name == &quot;kim cuong&quot;'>
<div style='width:70px;text-align:center;position:absolute;bottom:105px;right:5px;color:#fff'><img src='https://imgur.com/6M973Fd.png'/><br/> <div class='ranked' expr:data-url='data:post.url'/>  </div> </b:if>
<b:if cond='data:label.name == &quot;cao th?&quot;'>
<div style='width:70px;text-align:center;position:absolute;bottom:105px;right:5px;color:#fff'><img src='https://imgur.com/93vBT4F.png'/><br/> <div class='ranked' expr:data-url='data:post.url'/>  </div> </b:if>
</b:loop></b:if>   
  <div style='position:absolute;top:10px;left:10px;color:#fff;font-weight:bold'><data:post.title/></div>
<a expr:href='data:post.url' expr:title='data:post.title'><button class='btn' style='float:left;width:47%;font-weight:bold;color:#545454' type='button'><i class='fa fa-eye'/> Chi Tiết</button></a>
...
&lt;/style&gt;</b:widget-setting>
  ...
  <div class='widget-content'>
    ...
    <b:widget cond='!data:view.isPost' id='PageList1' locked='false' title='' type='PageList' visible='false'>
      <b:widget-settings>
        <b:widget-setting name='pageListJson'><![CDATA[{'home': {'href': 'http://shophieudepzai.blogspot.com/', 'title': 'Trang ch\u1ee7', 'position': 0}}]]></b:widget-setting>
  ...
  <ul>
    ...
    <b:widget id='Header1' locked='false' title='A (Tiêu đề)' type='Header' visible='true'>
      <b:widget-settings>
    ...
    <b:widget id='BlogSearch1' locked='false' title='Tìm kiếm Blog này' type='BlogSearch' visible='true'>
      <b:includable id='main'>
  <b:include name='widget-title'/>
  <b:include name='content'/>
</b:includable>
  ...
  <ul class='posts hierarchy'>
    ...
    <b:widget id='Label1' locked='false' title='Nhãn' type='Label' visible='true'>
      <b:widget-settings>
  ...
  <div class='widget-content'>
    ...
    <b:widget id='Profile1' locked='false' title='Giới thiệu về tôi' type='Profile' visible='true'>
      <b:widget-settings>
...
<div style='background:#2c343f'><div id='footer-wrapper'>
  <b:section class='left' id='left' preferred='yes'>
    <b:widget id='HTML5' locked='false' title='' type='HTML' visible='true'>
      <b:widget-settings>
        <b:widget-setting name='content'>&lt;script language=&quot;javascript&quot; type=&quot;text/javascript&quot;&gt; 
...
&lt;/script&gt;</b:widget-setting>
  ...
  <div class='right' id='right'>
    <b:section class='right1' id='right1' preferred='yes'>
      <b:widget id='Stats1' locked='false' title='LƯỢT TRUY CẬP SHOP' type='Stats' version='1'>
        <b:widget-settings>
...
<b:if cond='data:title != &quot;&quot;'>
    <h2 class='title'><data:title/></h2>
          ...
          <i class='fa fa-line-chart' style='font-size:30px;color:#c5d1cd'/><br/>
  <div class='widget-content'>
...
<b:section class='right2' id='right2' preferred='yes'>
  <b:widget id='HTML4' locked='false' title='' type='HTML' version='2' visible='true'>
    <b:widget-settings>
      <b:widget-setting name='content'>&lt;i class=&#39;fa fa-shopping-cart&#39; style=&#39;font-size:30px;color:#c5d1cd&#39;&gt;&lt;/i&gt;&lt;br/&gt;
&lt;div style=&#39;font-size:24px;height: 30px;line-height: 30px;vertical-align: top;direction: ltr&#39;&gt;
&lt;script style=&quot;text/javascript&quot;&gt;function showpostcount(json) {document.write(&#39;&lt;b&gt;&#39; + parseInt(json.feed.openSearch$totalResults.$t,10)+ &#39;&lt;/b&gt;&#39;);}&lt;/script&gt;&lt;script src=&quot;/feeds/posts/default?alt=json-in-script&amp;callback=showpostcount&quot;&gt;&lt;/script&gt;&lt;/div&gt;
Nick Ðang Bán</b:widget-setting>
    </b:widget-settings>
    <b:includable id='main'>
  <!-- only display title if it's non-empty -->
  <b:if cond='data:title != &quot;&quot;'>
...
<b:section class='right3' id='right3' preferred='yes'>
  <b:widget id='HTML6' locked='false' title='THÀNH VIÊN' type='HTML' version='2' visible='true'>
    <b:widget-settings>
      <b:widget-setting name='content'>&lt;br /&gt;1.AS MOBILE
&lt;br /&gt;2.SĨ KẸO
&lt;br /&gt;3.GAO BẠC
&lt;br /&gt;4.TOÀN TÂY</b:widget-setting>
    </b:widget-settings>
    <b:includable id='main'>
  <!-- only display title if it's non-empty -->
  <b:if cond='data:title != &quot;&quot;'>
...
<div class='clear'/>
<style>
#Stats1_content { font-weight:bold; font-size:24px; line-height:30px; vertical-align:top; direction:ltr; }
#footer-wrapper { max-width:1260px; background:#2c343f; overflow:hidden; margin:0 auto; padding:15px 15px 0; color:#ddd; font-size:14px; }
#footer-wrapper h2 { font-size:17px; color:inherit; }
#footer-wrapper .left { float:left; width:35%; }
#footer-wrapper .center { float:left; width:25%; }
#footer-wrapper .right { float:right; width:40%; }
#footer-wrapper .right .right1,#footer-wrapper .right .right2,#footer-wrapper .right .right3 { float:left; width:33.3%; text-align:center; color:#999; display:inline-block; }
#footer-wrapper .left .widget{ margin:0 15px 15px 0; clear:both; }
#footer-wrapper .center .widget { margin:0 10px 15px 15px; clear:both; }
#footer-wrapper .right .widget { margin:0; clear:both; }
@media screen and (max-width:900px) {
    #footer-wrapper .left { float:left; width:50%; } 
    #footer-wrapper .center { float:right; width:50%; } 
...
Vui Lòng Tôn Trọng Tác Giả </div>
<div class='site-bottomiu'>
<i>&#12298; không xóa dòng này&#12299;👉</i>
<span id='copyright-template'><a href='https://youtube.com/channel/UCDATJSlThJeq8F8locwBTLA'>HIẾU CYBER</a></span><br/></div>
</div></footer>
...
$(document).ready(function ($) {
    $('.ranked').each(function () {
        ...
        $.get(getURL, function (data) {
            var textgiaban = $(data).find('.rank').text();
            offer.html('' + textgiaban + '')
        }, "html")
    })
});
...
$(document).ready(function ($) {
    $('.champ').each(function () {
        var offer = $(this),
            getURL = offer.attr('data-url');
        $.get(getURL, function (data) {
            var textgiaban = $(data).find('.tuong').text();
            offer.html('' + textgiaban + '')
        }, "html")
    })
});
...
$(document).ready(function ($) {
    $('.trangphuc').each(function () {
        var offer = $(this),
            getURL = offer.attr('data-url');
        $.get(getURL, function (data) {
            var textgiaban = $(data).find('.skin').text();
            offer.html('' + textgiaban + '')
        }, "html")
    })
});
...
$(document).ready(function ($) {
    $('.botro').each(function () {
        var offer = $(this),
            getURL = offer.attr('data-url');
        $.get(getURL, function (data) {
            var textgiaban = $(data).find('.ngoc').text();
            offer.html('' + textgiaban + '')
        }, "html")
    })
});
...
$(document).ready(function ($) {
    $('.gia').each(function () {
        var offer = $(this),
            getURL = offer.attr('data-url');
        $.get(getURL, function (data) {
            var textgiaban = $(data).find('.giaban').text();
            offer.html('' + textgiaban + '')
        }, "html")
    })
});
...
<div id='popup'>
    <div class='hieu_popup_'>
     <br/>
        <h2>SỰ KIỆN TẾT 2021</h2>
  <code><p/><ol style='text-align: left;'><li>Nhân Dịp Tết Đến Xuân Về ADMIN Kính Chúc Năm Mới An Khang , Hạnh Phúc Và Tràn Đầy Niềm Vui.</li><li>Shop Game Chúng Tôi Có Event Phát Kim Cương Tại Shop.</li><li>Các Bạn Nhanh Tay Chia Sẻ Cho Mọi Người Để Cùng Nhau Nhận Nhá.</li></ol><div style='text-align: center;'><span style='color: red;'><b><strike>.HAPPY NEW YEAR 2021.</strike></b></span></div><p/><p><br/></p></code>
      <br/><br/>  <center> <a href='#close'><button class='btn'>Ðóng</button></a></center>
 </div></div>
    <style type='text/css'>
#fl813691{position:fixed;z-index:9999;right:0;border-radius:4px 4px 0 0;bottom:0;padding:2px;background:#4e4d4d}
#eb951855{width:300px;position:relative}Ĭ//Chiều rộng quảng cáo
#coh963846{color:#690;display:block;height:20px;line-height:20px;font-size:11px;width:100%}
#coh963846 a{color:#690;text-decoration:none}
#coc67178{float:right;padding:0;margin:0;list-style:none;overflow:hidden;height:15px}
#coc67178 li{display:inline}
#coc67178 li a{background-image:url(http://4.bp.blogspot.com/-53EJchH_4Bw/T2L-dTcqXNI/AAAAAAAAAng/RYJUMdSQLPQ/s1600/closebutton-namkna.gif);background-repeat:no-repeat;width:30px;height:0;padding-top:15px;overflow:hidden;float:left}
